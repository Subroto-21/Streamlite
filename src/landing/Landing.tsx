...
function ProductCanvas() {
  return (
    ...
    >
      ...
      >
        <div>
          <span style={{ color: "var(--mkt-pink)", "font-weight": "600" }}>
            novareign
          </span>
        ...
        <div>
          <span style={{ color: "var(--mkt-blue)", "font-weight": "600" }}>
            pixelwave
          </span>
          : built it in 2 min lol
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        Stream brighter.
        <br />
        <span style={{ color: "var(--mkt-green)" }}>
          Overlays that look pro
        </span>{" "}
        in minutes.
      </h1>
      ...
      <p
        style={{
          ...
          "max-width": "600px",
          margin: "22px auto 0",
          "line-height": "var(--mkt-lh-body-lg)",
        }}
      >
        Pick your widgets, position them on a live 16:9 canvas, tune them to
        your brand, copy one link into your broadcaster, and go live. Free to
      ...
      >
        <Pill size="lg" variant="primary" href="/builder.html" iconRight>
          Build your overlay
        </Pill>
        <Pill size="lg" variant="outline" href="/builder.html">
          Open builder
        </Pill>
      </div>
...
const FEATURES: Array<{ title: string; desc: string; category: Category }> = [
  {
    ...
    desc: "Position every widget on a live 16:9 canvas using precise controls. What you see is exactly what your viewers get.",
    category: "info",
  },
  {
    title: "Themeable to your brand",
    desc: "Colors, fonts, opacity, corner radius and entrance animations - per widget, in real time.",
    category: "info",
  },
  {
    title: "One link, any broadcaster",
    desc: "Copy a single overlay URL into OBS, Streamlabs or Twitch Studio as a browser source.",
    category: "integration",
  },
  {
    title: "Chat-command control",
    desc: "Show or hide widgets mid-stream with !overlay commands - no alt-tabbing away.",
    category: "chat",
  },
  {
    title: "Alerts that pop",
    desc: "Instant follow, sub and gift alerts with fade, slide and bounce animations - no account or signup needed.",
    category: "alerts",
  },
  {
    title: "Goals & hype",
    desc: "Follower goals with animated progress bars to rally your community toward the next milestone.",
    category: "alerts",
  },
];
  ...
  return (
    ...
    >
      <div style={{ "margin-bottom": "32px" }}>
        ...
        <h2
          style={{
            "font-size": "var(--mkt-text-heading-sm)",
            "font-weight": "600",
            "letter-spacing": "var(--mkt-ls-heading-sm)",
            color: "var(--mkt-cream)",
            "font-family": "var(--mkt-font)",
            margin: "8px 0 0",
          }}
        >
          Built for every kind of streamer
        </h2>
      </div>
      <div
        style={{
...
const WIDGETS: Array<{
  ...
  },
  {
    name: "Alert Box",
    emoji: "🔔",
    desc: "Instant pop-ups for follows, subs and gifted subs with smooth animations. Sub and gift alerts include the viewer’s name - no account needed.",
    category: "alerts",
  },
  {
    name: "Follower / Sub Goal",
    emoji: "🎯",
    desc: "Animated progress bars showing your community how close you are to the next milestone.",
    category: "alerts",
  },
  {
    name: "Viewer Count",
  ...
  },
  {
    name: "Stream Labels",
    emoji: "🏷️",
    desc: "Latest follower, latest sub, top gifter, follower/sub/viewer counts - pick and arrange.",
    category: "alerts",
  },
  {
    name: "QR Code",
    ...
    <>
      ...
      >
        <div style={{ "margin-bottom": "32px" }}>
          ...
          >
            14 widgets, zero configuration
          </h2>
          <p
            style={{
              "font-size": "var(--mkt-text-body-sm)",
              color: "var(--mkt-muted)",
              margin: "12px 0 0",
              "max-width": "500px",
              "line-height": "1.6",
          ...
          >
            Drop any widget onto your canvas and it works immediately. No
            accounts, no API keys for most, no setup headaches.
          </p>
        </div>
        ...
        <div style={{ "text-align": "center", "margin-top": "36px" }}>
          <Pill variant="outline" href="/builder.html" iconRight>
            Try all widgets free
          </Pill>
        </div>
      </section>
    </>
...
const OBS_STEPS: Array<{
  ...
  {
    n: "1",
    title: "Build & copy your link",
    body: "Pick your widgets, arrange them on the canvas, and copy the single overlay URL from the bottom of the builder.",
    art: () => (
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        <span
          style={{
            ...
            "font-weight": "700",
            color: "var(--mkt-green)",
            border: "1px solid var(--mkt-green)",
            "border-radius": "6px",
            padding: "4px 9px",
            "flex-shrink": "0",
          }}
  ...
  },
  {
    ...
    body: "In OBS, under Sources click + → Browser. Paste your link and set the size to 1920 × 1080.",
    art: () => (
      <div
        style={{
          width: "100%",
      ...
      >
        ...
        >
          <span style={{ "font-size": "14px" }}>🌐</span> Browser
        </div>
      </div>
    ),
  },
  {
    n: "3",
    title: "Go live",
    body: "Your widgets appear over your stream instantly. A quick connection badge confirms it - then hides itself. Edit anytime and refresh the source.",
    art: () => (
      <div
        style={{
          display: "inline-flex",
    ...
    <>
      ...
      >
        <div style={{ "margin-bottom": "32px" }}>
          ...
          >
            No install, no plugin, no account. One browser source and you're on
            air. Works the same in Streamlabs and Twitch Studio.
          </p>
        </div>
    ...
    >
      <div
        style={{
          background: "var(--mkt-canvas)",
          "border-radius": "var(--mkt-radius-card)",
          border: "1px solid var(--mkt-cream)",
          padding: "48px 40px",
          "text-align": "center",
        }}
      >
        ...
        >
          No trial period. No credit card. No hidden tier.
          <br />
        ...
        >
          <For each={FREE_FEATS}>
            {(feat) => (
              ...
              >
                <span style={{ color: "var(--mkt-green)", "flex-shrink": "0" }}>
                  <IconCheck />
                </span>
                {feat}
              </div>
    ...
    >
      ...
      >
        <img
          src="/logo-mark.svg"
          alt=""
          style={{ width: "44px", height: "44px", "margin-bottom": "20px" }}
        />
        <h2
          style={{
            "font-size": "var(--mkt-text-heading)",
            "font-weight": "600",
            "letter-spacing": "var(--mkt-ls-heading)",
            color: "var(--mkt-cream)",
            "max-width": "640px",
            margin: "0 auto",
            "font-family": "var(--mkt-font)",
        ...
        >
          Your next stream deserves a better overlay
        </h2>
        <p
          style={{
            "font-size": "17px",
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", "align-items": "center", gap: "4px" }}>
          <Pill variant="ghost" size="sm" href="/feature-request.html">
            Feature Request
          </Pill>
          <Pill variant="ghost" size="sm" href="/builder.html" iconRight>
            Open Builder
          </Pill>
        </div>
      </div>
