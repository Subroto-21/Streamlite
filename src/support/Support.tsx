...
const Support: Component = () => {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      await sendFeedback({
        subject: "[Support] Message from Streamlite",
        from_name: "Streamlite Support",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Streamlite is built and maintained by one person. Response times may
          vary, but every message is read.
        </p>
        ...
        >
          ...
          >
            ...
            <div style={cardStyle}>
              ...
              >
                Send any amount directly via PayPal - one-time, no strings
                attached. Works from anywhere in the world.
              </p>
              <Pill
                variant="outline"
            ...
            <div style={cardStyle}>
              ...
              >
                <path
                  d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12 12-5.373 12-12S18.628 0 12 0zm5.618 9.48l-5.84 8.72a.72.72 0 0 1-1.207-.033L7.4 13.72a.72.72 0 0 1 1.2-.79l2.54 3.85 5.24-7.82a.72.72 0 0 1 1.238.52z"
                  fill="#34A853"
                />
              </svg>
              <h2
              ...
              >
                In India? Send directly via GPay, PhonePe, or any UPI app -
                instant and free.
              </p>
              <div
                style={{
          ...
          <div style={cardStyle}>
            ...
            >
              Got an idea for a new widget, integration, or improvement? Submit
              a request and it'll go straight to the top of the roadmap
              consideration.
            </p>
            <Pill
              variant="outline"
